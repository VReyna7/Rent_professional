...
<head>
    ...
    <link rel="stylesheet" href="../css/vis.modificarNombre.css?v=<?php echo time(); ?>">
...
<body>
    <div class="containerKing">
        ...
        <div class="container">
            <div class="contenido">
                <h3>Digitar nombres y apellidos</h3>
                <form class="cambios" action="../controlador/modificarNombre.php" method="POST">
                    <input type="text" name="nombre" placeholder="Victor Isaías" required autocomplete="off" class="nombres">
			        <input type="text" name="apellido" placeholder="Reyna Pimentel" required autocomplete="off" class="apellidos">
